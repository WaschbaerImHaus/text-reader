...
func TestBuildInitialHTML_ContainsDoctype(t *testing.T) {
	html := BuildInitialHTML(UIConfig{FontSize: 16, Theme: "light", IsPortrait: false})
...
func TestBuildInitialHTML_FontSize(t *testing.T) {
	// Standardgröße
	html := BuildInitialHTML(UIConfig{FontSize: 16, Theme: "light"})
	...
	// Andere Größe
	html32 := BuildInitialHTML(UIConfig{FontSize: 32, Theme: "light"})
...
func TestBuildInitialHTML_ThemeDark(t *testing.T) {
	html := BuildInitialHTML(UIConfig{FontSize: 16, Theme: "dark"})
...
func TestBuildInitialHTML_ThemeRetro(t *testing.T) {
	html := BuildInitialHTML(UIConfig{FontSize: 16, Theme: "retro"})
...
func TestBuildInitialHTML_PortraitMode(t *testing.T) {
	html := BuildInitialHTML(UIConfig{FontSize: 16, Theme: "light", IsPortrait: true})
