...
- [x] PDF-Anzeige (.pdf) – Linux: pdftoppm → PNG-Bilder (Build 36); Windows: Edge WebView2 embed (Build 34)
- [x] PostScript-Anzeige (.ps) – gs rendert direkt zu PNG-Bildern (Build 37); Fallback: Hinweis + Quelltext
